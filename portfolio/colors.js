module.exports = {
  background: '#FFFFFF' /* color of links at top of page; white */,
  backgroundDark:
    '#c4fffd' /* color of small middle triangle on lading page; light robin's egg blue */,

  primary:
    '#000dff' /* color of "Hello..." text and card links; dark royal blue */,
  primaryLight: '#23bff7' /* color of card links on hover text; aqua */,
