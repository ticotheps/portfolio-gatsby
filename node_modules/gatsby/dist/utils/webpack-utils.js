    ...
    let js = (_ref = {}) => {
      let {
        exclude = []
          ...
          options = (0, _objectWithoutPropertiesLoose2.default)(_ref, ["exclude"]);
      const excludeRegex = [`core-js|event-source-polyfill|webpack-hot-middleware/client`].concat(exclude);
      return {
        test: /\.(js|mjs|jsx)$/,
