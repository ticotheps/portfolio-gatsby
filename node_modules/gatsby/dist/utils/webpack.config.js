...
module.exports = async (program, directory, suppliedStage) => {
  ...
  function getModule() {
    const jsOptions = {}; // Speedup 🏎️💨 the build! We only include transpilation of node_modules on production builds
    ...
    let configRules = [rules.js(jsOptions), rules.yaml(), rules.fonts(), rules.images(), rules.media(), rules.miscAssets()];
